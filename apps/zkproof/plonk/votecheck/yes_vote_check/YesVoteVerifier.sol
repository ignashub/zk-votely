...
contract PlonkVerifier {
  ...
  uint256 constant Qlx =
    19316303731074698766522643413236867551628553303005804663113251829576007374929;
  uint256 constant Qly =
    7976195710438084046940307916550525670365334887080679360318197479296984495118;
  uint256 constant Qrx = 0;
  uint256 constant Qry = 0;
  uint256 constant Qox = 0;
  uint256 constant Qoy = 0;
  uint256 constant Qcx =
    16127928492299621377005581382343652669473948354130505161893173309488665588775;
  uint256 constant Qcy =
    10221319074789719534547056843469028923667245905108338247519717861218502577327;
  uint256 constant S1x =
    17852296676048980561898053338340788587246066458156962859450122727164333562315;
  uint256 constant S1y =
    10550725175825609901634003731947913991841354870457465732958749473585878955082;
  uint256 constant S2x =
    8546085144018841236307259500347353454397562948381848826469898044761541512860;
  uint256 constant S2y =
    13544216776527930947876393658396255725842266422094498948552094410921509390092;
  uint256 constant S3x =
    8617663946423845615334540342975299786991276880662220784105516869354470217522;
  uint256 constant S3y =
    15380952689966032332611649655573860847266557101305444777701251269000369228306;
  uint256 constant k1 = 2;
  uint256 constant k2 = 3;
  uint256 constant X2x1 =
    15826101866445834142053863241857907645067163138935672404833254548011322671777;
  uint256 constant X2x2 =
    3865624845009702785586109165967243805969357789448409733095244049796982273994;
  uint256 constant X2y1 =
    5536194998055120799732263820586216445000091851851013090723841061939354802134;
  uint256 constant X2y2 =
    299260454212709923991412804118628397210361951928688456347862967081630395590;
